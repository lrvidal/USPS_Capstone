...
ROGOWSKY_PERIPHERAL_ADDRESS = 0x50
...
class GUI:
    ...
    def updatePhaseTrends(self):
        ...
        self.phase_axs[0, 0].text(0.5, 0.5, phaseStatusMessages[phaseStatus], fontsize=20, ha='center', color=phaseStatusColor)
        self.phase_canvas.draw()
...
def isMeasurementConcerning(type, value):
    return float(value) > CONCERNING_PARAMS[type]
