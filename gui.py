...
dataProvider = DataProvider(thermo1Bus=SPI_BUS, thermo1Device=THERMO1_DEVICE,
                            ...
                            rogowskyPort=ROGOWSKY_PORT, rogowskyAdress=ROGOWSKY_PERIPHERAL_ADDRESS
                            )
...
class GUI:
    ...
    def updateCurrentAirPressure(self):
        ...
        self.air_axs[0, 0].text(0.5, 0.5, data + " psi", fontsize=30, ha='center', color=airPressureColor)
        self.air_canvas.draw()
    ...
    def updateCurrentAirTemperature(self):
        ...
        data = "%.2f" % data if type(data) is not str else data
        self.air_axs[2, 0].text(0.5, 0.5, data + " °F", fontsize=35, ha='center', color=airTempColor)
        self.air_canvas.draw()
    ...
    def updateWaterLevelStatus(self):
        ...
        self.oil_axs[1, 1].text(0.5, 0.5, waterLevelMessages[waterLevelStatus], fontsize=30, ha='center', color=waterLevelColor)
        self.oil_canvas.draw()
## CONSTANTS ZONE ##
